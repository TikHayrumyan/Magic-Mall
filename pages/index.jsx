  ...
  return (
    <div>
      ...
      {mainSliderData?.loading && (
        <OwlCarousel
          {...settingsMain}
          className="owl-theme home-owl"
          items={1}
          loop
          margin={0}
          navText={[
            `<img src='/img/homePage/sectionMainSlider/nav-prev.svg' alt='' />`,
            `<img src='/img/homePage/sectionMainSlider/nav-next.svg' alt='' />`,
          ]}
          nav
        >
          {mainSliderData?.loading &&
            mainSliderData?.data?.map(
              ({
                id,
                image,
                image_am,
                ...
                return (
                  <div key={id} className={stylesMainSliderHomePage.itemOne}>
                    <div className={stylesMainSliderHomePage.gradient}></div>
                    <img
                      alt=""
                      className={stylesMainSliderHomePage.backgroundImage}
                      src={lang == "en" ? HOST_API_IMG + image : lang == "ru" ? HOST_API_IMG + image_ru : HOST_API_IMG + image_am}
                    />
                    <div className={stylesMainSliderHomePage.blockData}>
                      <h2 className={stylesMainSliderHomePage.title}>
                        {lang == "en" ? title : lang == "ru" ? title_ru : title_am}
                      </h2>
                      <p className={stylesMainSliderHomePage.info}>
                        {lang == "en" ? description : lang == "ru" ? description_ru : description_am}
                      </p>
                      {link && link_ru && link_am && (
                        <Link href={lang == "en" ? link : lang == "ru" ? link_ru : link_am}>
        ...
        <div className={stylesBrandsSlide.sliderContainer}>
          <Slider {...settingsBrand}>
            {brandsSliderData?.loading &&
              brandsSliderData.data?.map(({ id, image, link }) => {
                return (
      ...
      <div className={stylesBestBrands.bestBrands}>
        <div className={stylesBestBrands.container}>
          <div className={stylesBestBrands.descAndPatter}>
            <div className={stylesBestBrands.pattern}>
              <Image alt="pattern" src="/img/homePage/sectionBestBrands/pattern.svg" width={170} height={170} />
            </div>
          ...
          <div className={stylesBestBrands.descAndPatterMobile}>
            <div className={stylesBestBrands.patternAndTitleMobile}>
              <div className={stylesBestBrands.patternMobile}>
                <Image alt="pattern" src="/img/homePage/sectionBestBrands/pattern.svg" width={170} height={170} />
              </div>
            ...
            <>
              <div className={stylesYourInterest.secondBlock}>
                <Link href={interestedData.data[2].link}>
                  <div
                    className={stylesYourInterest.thirdPic}
                    style={{ backgroundImage: `url(${HOST_API_IMG + interestedData.data[2].image})` }}
                  >
                    <span className={stylesYourInterest.title}>
                      {lang == "en"
                        ? interestedData.data[2].title
                        : lang == "ru"
                        ? interestedData.data[2].title_ru
                        : interestedData.data[2].title_am}
                    </span>
                  </div>
                </Link>
                <Link href={interestedData.data[3].link}>
                  <div
                    className={stylesYourInterest.fourPic}
                    style={{ backgroundImage: `url(${HOST_API_IMG + interestedData.data[3].image})` }}
                  >
                    <span className={stylesYourInterest.title}>
                      {lang == "en"
                        ? interestedData.data[3].title
                        : lang == "ru"
                        ? interestedData.data[3].title_ru
                        : interestedData.data[3].title_am}
                    </span>
                  </div>
                </Link>
              </div>
              <div className={stylesYourInterest.thirdBlock}>
                <div className={stylesYourInterest.fiveAndSixBlock}>
                  <Link href={interestedData.data[4].link}>
                    <div
                      className={stylesYourInterest.fivePic}
                      style={{ backgroundImage: `url(${HOST_API_IMG + interestedData.data[4].image})` }}
                    >
                      <span className={stylesYourInterest.title}>
                        {lang == "en"
                          ? interestedData.data[4].title
                          : lang == "ru"
                          ? interestedData.data[4].title_ru
                          : interestedData.data[4].title_am}
                      </span>
                    </div>
                  </Link>
                  <Link href={interestedData.data[5].link}>
                    <div
                      className={stylesYourInterest.sixPic}
                      style={{ backgroundImage: `url(${HOST_API_IMG + interestedData.data[5].image})` }}
                    >
                      <span className={stylesYourInterest.title}>
                        {lang == "en"
                          ? interestedData.data[5].title
                          : lang == "ru"
                          ? interestedData.data[5].title_ru
                          : interestedData.data[5].title_am}
                      </span>
                    </div>
                  </Link>
                </div>
                <Link href={interestedData.data[6].link}>
                  <div
                    className={stylesYourInterest.sevenPic}
                    style={{ backgroundImage: `url(${HOST_API_IMG + interestedData.data[6].image})` }}
                  >
                    <span className={stylesYourInterest.title}>
                      {lang == "en"
                        ? interestedData.data[6].title
                        : lang == "ru"
                        ? interestedData.data[6].title_ru
                        : interestedData.data[6].title_am}
                    </span>
                  </div>
                </Link>
              </div>
      ...
      <div className={stylesBlog.blog}>
        <div className={stylesBlog.container}>
          <div className={stylesBlog.titleBlock}>
            ...
            <div className={stylesBlog.backPattern}>
              <Image alt="pattern" src="/img/homePage/secBlog/secondPattern.png" height={900} width={737} />
            </div>
          </div>
          <BlogSLider />
        </div>
      ...
      {giftCardHomePageData?.loading && (
        <div className={stylesGiftCard.giftCard}>
          <div className={stylesGiftCard.container}>
            <Link href="/giftCardPage">
              <div className={stylesGiftCard.hoverBlockMobile}>
                ...
                <div className={stylesGiftCard.buttonIconMobile}>
                  <img alt="arrRight" src="/img/homePage/secBlog/arrRight.svg" />
                </div>
              </div>
            </Link>
            <div className={stylesGiftCard.pattern}>
              <Image alt="pattern" src="/img/homePage/secBlog/secondPattern.png" width={941} height={750} />
            </div>
            <div className={stylesGiftCard.giftCardImg}>
              <Image alt="giftCard" src="/img/homePage/secGiftCard/giftCardImgNew.png" width={641} height={748} />
            </div>
            <div className={stylesGiftCard.aboutBlock}>
              <div className={stylesGiftCard.titleBlock}>
                ...
                <div className={stylesGiftCard.secondPattern}>
                  <Image alt="pattern" src="/img/homePage/secBlog/firstPattern.svg" width={170} height={170} />
                </div>
              </div>
              {
                <div className={stylesGiftCard.descrip}>
                  {parse(
                    lang == "en"
                      ? shorten(giftCardHomePageData.data.content, 425)
                      : lang == "am"
                      ? shorten(giftCardHomePageData.data.content_am, 390)
                      : shorten(giftCardHomePageData.data.content_ru, 390)
                  )}
                </div>
              }
              <Link href="/giftCardPage">
                <div className={stylesGiftCard.hoverBlock}>
                  ...
                  <div className={stylesGiftCard.buttonIcon}>
                    <img alt="arrRight" src="/img/homePage/secBlog/arrRight.svg" />
                  </div>
                </div>
              </Link>
      ...
      <div className={stylesNews.news}>
        <div className={stylesNews.container}>
          <div className={stylesNews.titleBlock}>
            <div className={stylesNews.pattern}>
              <Image alt="pattern" src="/img/homePage/secBlog/firstPattern.svg" width={170} height={170} />
            </div>
