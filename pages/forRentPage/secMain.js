  ...
  return (
    <div className={styles.secMain}>
      <div className={styles.container}>
        <div className={styles.background} style={{ backgroundImage: `url(/img/forRentPage/secMain/background.jpg)` }}>
          <div className={styles.gradientt}></div>
          <div className={styles.patternAndTitle}>
            <div className={styles.pattern}>
              <img className={styles.pattern} alt="pattern" src="/img/forRentPage/secMain/pattern.svg" />
            </div>
