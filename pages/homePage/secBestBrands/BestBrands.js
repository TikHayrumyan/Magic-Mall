    ...
    return(<div className={styles.bestBrands}>
        <div className={styles.container}>
            <div className={styles.descAndPatter}>
                <div className={styles.pattern}><img alt="pattern" src="/img/homePage/sectionBestBrands/pattern.svg"/></div>
            ...
            <div className={styles.descAndPatterMobile}>
                <div className={styles.patternAndTitleMobile}>
                    <div className={styles.patternMobile}><img alt="pattern" src="/img/homePage/sectionBestBrands/pattern.svg"/></div>
