...
import backgroundPattern from "../../../public/img/FAQpage/backgroundPattern.png"
...
const Questions = () => {
    ...
    return(
        <div className={styles.Questions}>
            <div className={styles.backgroundPattern}><Image alt="backgroundPattern" src={backgroundPattern}/></div>
