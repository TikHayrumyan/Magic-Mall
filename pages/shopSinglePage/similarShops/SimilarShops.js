      ...
      {related && (
        <div className={styles.container}>
          ...
          <div className={styles.similarBrands}>
            {related?.map(
              ({ id, thumbnail, floor, name, name_am, name_ru, phone, logo, facebook, instagram, sale, sale_am, sale_ru }) => {
                return (
                  <Link key={id} href={`/shopSinglePage/${id}`}>
                    <a>
                      <div className={styles.first} style={{ backgroundImage: `url(${HOST_API_IMG + thumbnail})` }}>
                        <div className={styles.patternBlock}>
                          {sale && (
                            <div
                              className={styles.salePattern}
                              style={{ backgroundImage: `url(/img/shopPage/secFilter/salePattern.svg)` }}
                            >
                          ...
                          {sale && (
                            <div
                              className={styles.salePatternMobile}
                              style={{ backgroundImage: `url(/img/shopPage/secFilter/salePatternMobile.svg)` }}
                            >
                              <div className={styles.titleSaleMobile}>
                                <div className={styles.saleMobile}>{translate.sale[lang]}</div>
                                <div className={styles.saleUntilMobile}>
                                  {lang == "en" ? sale : lang == "ru" ? sale_ru : sale_am}
                                </div>
                              </div>
                            </div>
                          )}
                          <div
                            ...
                            style={{ backgroundImage: `url(/img/shopSinglePage/similarShops/cutPattern.svg)` }}
                          >
                        ...
                        <div className={styles.hoverBlock}>
                          ...
                          {phone && (
                            <div className={styles.phonBlock}>
                              <div className={styles.phoneIcon}>
                                <img alt="phoneIcon" src="/img/icons/whitPhoneIcon.svg" />
                              </div>
                              <div>
                                <a className={styles.number} href={`tel:${phone}`}>
                                  {phone}
                                </a>
                              </div>
                            </div>
                        ...
                        <div className={styles.brandBook}>
                          ...
                          <div className={styles.iconBook}>
                            <img alt="iconBook" src="/img/shopSinglePage/similarShops/iconBook.svg" />
                          </div>
                        </div>
                      </div>
                    </a>
