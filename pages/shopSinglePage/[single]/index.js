...
const SingleShop = ({ data }) => {
  ...
  return (
    <>
                ...
                <a>
                  <div className={styles.forHover}>
                    <div className={styles.arrow}>
                      <Image alt="arrow" width={32} height={18} src="/img/shopSinglePage/singleShop/Rarrow.svg" />
                    </div>
            ...
            <div className={styles.mainBlock}>
              <div className={styles.forMobileContainer}>
                <div className={styles.logoBlock}>
                  <div className={styles.Logo}>
                    <img className={styles.Logo} alt="logo" src="/img/shopSinglePage/singleShop/Logo.svg" />
                  </div>
                  <div className={styles.brandName}>
                    {lang == "en"
                      ? activeSinglePage.data.shop?.name
                      : lang == "ru"
                      ? activeSinglePage.data.shop?.name_ru
                      : activeSinglePage.data.shop?.name_am}
                  </div>
                </div>
                <div className={styles.imgsMobile}>
                  <div className={styles.imgsBlockMobile}>
                    <div className={styles.patternMobile}>
                      <img alt="pattern" src="/img/shopSinglePage/singleShop/pattern.svg" />
                    </div>
                    <div>
                      <img
                        className={styles.brandLogoMobile}
                        alt="brandLogo"
                        src={HOST_API_IMG + activeSinglePage.data.shop?.logo}
                      />
                    </div>
                    <div>
                      <img
                        className={styles.accessoriesMobile}
                        alt="accessories"
                        src={HOST_API_IMG + activeSinglePage.data.shop?.imgSmall}
                      />
                    </div>
                    <div>
                      <img className={styles.burgerMobile} alt="burger" src={HOST_API_IMG + activeSinglePage.data.shop?.imgBig} />
                    </div>
                  </div>
                </div>
                <div className={styles.descripBlock}>
                  <div className={styles.description}>
                    {lang == "en"
                      ? parse(activeSinglePage.data.shop?.content)
                      : lang == "ru"
                      ? parse(activeSinglePage.data.shop?.content_ru)
                      : parse(activeSinglePage.data?.shop.content_am)}
                  </div>
                </div>
                <div className={styles.contactBlock}>
                  {activeSinglePage.data.shop?.phone && (
                    <div className={styles.phoneIcon}>
                      <img alt="phoneIcon" src="/img/shopSinglePage/singleShop/phoneIcon.svg" />
                    </div>
                  )}
                  {activeSinglePage.data.shop?.phone && (
                    <div>
                      <a className={styles.number} href={`tel:${activeSinglePage.data.shop?.phone}`}>
                        {activeSinglePage.data.shop?.phone}
                      </a>
                    </div>
                  )}
                  {activeSinglePage.data.shop?.linkedin && (
                    <div className={styles.Linkdin}>
                      <Link href={activeSinglePage.data.shop?.linkedin}>
                        <a target="_blank">
                  ...
                  {activeSinglePage.data.shop?.facebook && (
                    <div className={styles.Facebook}>
                      <Link href={activeSinglePage.data.shop?.facebook}>
                        <a target="_blank">
                  ...
                  {activeSinglePage.data.shop?.instagram && (
                    <div className={styles.Instagram}>
                      <Link href={activeSinglePage.data.shop?.instagram}>
                        <a target="_blank">
              ...
              <div className={styles.imgs}>
                <div className={styles.imgsBlock}>
                  ...
                  <div>
                    <img className={styles.brandLogo} alt="brandLogo" src={HOST_API_IMG + activeSinglePage.data.shop?.logo} />
                  </div>
                  <div>
                    <img
                  ...
                  <div>
                    <img className={styles.burger} alt="burger" src={HOST_API_IMG + activeSinglePage.data.shop?.imgBig} />
                  </div>
                </div>
              </div>
      ...
      {activeSinglePage.loading && (
        <SpecialOffer SpecialOffer={activeSinglePage.data?.specialOffers} loading={activeSinglePage.loading} />
      )}
